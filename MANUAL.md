# Manual Setup Steps for Minions Releases
...
Go to **GitHub → mxn2020/minions-releases → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-releases` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-releases-web`
- **GitHub repo**: `mxn2020/minions-releases`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `releases.minions.wtf`

### Documentation
- **Netlify site name**: `minions-releases-docs`
- **GitHub repo**: `mxn2020/minions-releases`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `releases.minions.help`

### Blog
- **Netlify site name**: `minions-releases-blog`
- **GitHub repo**: `mxn2020/minions-releases`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `releases.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `releases.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `releases.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `releases.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-releases/sdk`](https://www.npmjs.com/package/@minions-releases/sdk)
- CLI: [`@minions-releases/cli`](https://www.npmjs.com/package/@minions-releases/cli)
...
Your package: [`minions-releases`](https://pypi.org/project/minions-releases/)
...
| Item | Value |
|------|-------|
| Project | `minions-releases` |
| SDK (npm) | `@minions-releases/sdk` |
| CLI (npm) | `@minions-releases/cli` |
| Python (PyPI) | `minions-releases` |
| GitHub | `github.com/mxn2020/minions-releases` |
| Docs domain | `releases.minions.help` |
| Blog domain | `releases.minions.blog` |
| App domain | `releases.minions.wtf` |
