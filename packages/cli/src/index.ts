...
/**
 * @minions-releases/cli — CLI for Minions Releases
 *
...
import { customTypes } from '@minions-releases/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Releases'));
        console.log(chalk.dim('Release planning, version bumps, changelog generation, and publish targets'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-releases/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-releases/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-releases')}`);
