...
- `@minions-releases/sdk` (npm package)
- `minions-releases` (PyPI package)
- `@minions-releases/cli` (npm package)
- The minions-releases web playground
- The minions-releases documentation site
